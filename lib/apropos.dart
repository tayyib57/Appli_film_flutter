...
class _MyHomePageState extends State<MyHomePage> {
  final controller = MapController(
    location: LatLng(48.869745, 2.307946),
  );

  bool _darkMode = false;

  final markers = [
    LatLng(48.869745, 2.307946),
  ];

  void _gotoDefault() {
    controller.center = LatLng(48.869745, 2.307946);
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      body: MapLayoutBuilder(
        ...
        builder: (context, transformer) {
          ...
          final homeLocation =
              transformer.fromLatLngToXYCoords(LatLng(48.869745, 2.307946));

          final homeMarkerWidget =
              _buildMarkerWidget(homeLocation, Colors.black);

          final centerLocation = Offset(
              transformer.constraints.biggest.width / 1,
              transformer.constraints.biggest.height / 1);
